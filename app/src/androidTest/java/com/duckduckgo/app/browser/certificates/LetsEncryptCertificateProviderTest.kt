...
class LetsEncryptCertificateProviderTest {
    ...
    private val certificateProvider = CertificatePluginProviderModule()
        .provideLetsEncryptCertificateProvider(InstrumentationRegistry.getInstrumentation().targetContext.applicationContext)
